...
Для проекта это меняет две вещи: сколько вы платите и как долго ждёте ответ. По деньгам и скорости вы получаете модель уровня 95 миллиардов параметров, а не 2,4 триллиона. Обратное тоже верно — число из заголовка пресс-релиза само по себе не обещает качества.
