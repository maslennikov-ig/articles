...
| Параметр | Regex + ML модели | LLM (ChatGPT/Claude) |
|----------|-------------------|----------------------|
| **Скорость** | 5-20ms на документ | 500-2000ms на документ |
| **Стоимость** | Бесплатно | ~$0.00017 за запрос |
| **Предсказуемость** | 100% одинаково | Может варьироваться |
| **Compliance** | Легко для аудита | Сложнее объяснить |
