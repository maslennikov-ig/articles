...
- **alt:** `Ровная стена из блоков рядом с раскачивающимися качелями`
...
| `04-stena-i-kacheli` | раздел «Средний балл врёт: смотрите на разброс» | Ровная стена из блоков рядом с раскачивающимися качелями | Две модели с похожим средним баллом. Одна одинакова на любом клиенте, вторая проваливается на неудобном |
