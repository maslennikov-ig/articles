...
Нужен один файл: `01-hero`. **Выбран вариант 2** (две башни) — alt в итоговой таблице приведён под него.
...
|---|---|---|---|
| `01-hero` | обложка статьи (`featuredImage`) | Кривая башня из блоков с прорехами у основания и рядом такая же башня, сложенная ровно на широком основании | — |
