...
part: 2 of 3
title: "Как работает AI-оркестратор изнутри: 5 фаз, 33 агента и автоматические циклы"
...
В [первой части](https://vc.ru/...) я рассказал про главную идею: превратить Claude Code в профессиональный оркестратор с 33 специализированными агентами. Показал **главный результат**: -80% стоимости, 1-2 недели вместо 2-3 месяцев, 5-7 проектов одновременно.
