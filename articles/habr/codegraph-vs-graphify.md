...
Graphify я, повторюсь, ещё не гонял на боевом — это в планах. Если кто-то уже сравнивал обе на реальном проекте, замерял экономику Graphify или нашёл что-то третье поинтереснее — напишите в комментариях, очень интересно, кто чем индексирует код для агентов. Можно и не в комментариях: ссылки на обе системы, команды установки и готовые промпты внедрения для обеих (копируешь в агента — он сам разворачивает инструмент и прописывает себе правило ходить в граф, а не грепать) я выложу в [Telegram-канале](https://t.me/maslennikovigor) — туда же заходите обсудить, если формат комментариев не ваш. Для прямой связи — [@maslennikovig](https://t.me/maslennikovig).
