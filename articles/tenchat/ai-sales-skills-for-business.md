...
Я в IT с 2013 года. Последние два года занимаюсь AI-разработкой в DNA IT — традиционной IT-компании с 80+ специалистами. Создал отдельное подразделение AI Dev Team: 54 специалиста + 44 AI-агента. На каждый проект работают 3-7 человек + AI-агенты.
...
Я использую **Claude Code Orchestrator Kit** — набор из 44 AI-агентов для разработки. Но недавно обнаружил там 3 скилла (Skills), которые напрямую закрывают задачи продаж и маркетинга:
...
**AI Dev Team**:
- 54 специалиста в AI Dev Team, на каждый проект — команда 3-7 человек
- 44 AI-агента для разработки
