...
Игорь Масленников, в IT с 2013 года. Последние 2 года занимаюсь AI и автоматизацией разработки. Работаю в DNA IT, где мы создали AI Dev Team — подразделение из 54 специалистов + 44 AI-агентов, которое работает в разы эффективнее традиционных команд за счёт AI-усиления.
