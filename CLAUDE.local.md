# Local Memory - Articles Project

## Company Facts (AI Dev Team)
...
- Skills: ~30 штук
- Cost reduction: -80%
- Speed improvement: 2-3 месяца → 1-2 недели (~75% быстрее)
- Parallelization: 3-5x (5-7 проектов одновременно)
...
- Первое лицо от имени Игоря Масленникова
- Антипафос, без корпоративного языка
- Обязательные секции: "Disclaimer" и "Контакты"
- Промты для картинок на английском с рейтингом (★)
